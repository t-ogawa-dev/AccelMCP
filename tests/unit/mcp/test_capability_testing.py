...
def test_capability(db):
    ...
    capability = Capability(
        ...
        body_params=json.dumps({"properties": {"query": {"type": "string", "description": "Search query"}}}),
    )
...
def test_test_execution_success(mock_post, client, db, test_capability):
    ...
    # Execute test
    response = client.post(f"/api/capabilities/{test_capability.id}/test", json={"params": {"query": "test"}})
...
def test_test_execution_uses_capability_timeout(mock_post, client, db):
    ...
    # Execute test
    client.post(f"/api/capabilities/{capability.id}/test", json={"params": {}})
