...
from app.models.models import Capability, ConnectionAccount, McpService, Resource, Service
...
class TestMcpProtocolToolsList:
    ...
    def test_tools_list_restricted_access_with_auth(self, client, db):
        ...
        account = ConnectionAccount(name="Test Account", bearer_token="test-token-123")
        ...
        permission = AccountPermission(account_id=account.id, mcp_service_id=mcp_service.id)
...
class TestMcpProtocolToolsCall:
            ...
            data=json.dumps(
                {
                    ...
                    "id": 1,
                    "method": "tools/call",
                    "params": {"name": "public-mcp-call_Test_App:test_tool", "arguments": {"input": "test value"}},
                }
            ),
            content_type="application/json",
        )
    ...
    def test_tools_call_missing_params(self, client, db):
        ...
        response = client.post(
            ...
            data=json.dumps({"jsonrpc": "2.0", "id": 1, "method": "tools/call", "params": {"arguments": {}}}),
            content_type="application/json",
        )
            ...
            data=json.dumps(
                {
                    ...
                    "id": 1,
                    "method": "tools/call",
                    "params": {"name": "tool-type-test_Weather_App:get_weather", "arguments": {"city": "130000"}},
                }
            ),
            content_type="application/json",
        )
...
class TestMcpProtocolResourcesRead:
    ...
    def test_resources_read_global_resource(self, client, db):
        ...
        resource_uri = "resource://public-mcp-read/test_doc"
        cap = Capability(
            app_id=app.id,
            name="test_doc",
            capability_type="resource",
        ...
        response = client.post(
            ...
            data=json.dumps({"jsonrpc": "2.0", "id": 1, "method": "resources/read", "params": {"uri": resource_uri}}),
            content_type="application/json",
        )
    ...
    def test_resources_read_missing_uri(self, client, db):
        ...
        response = client.post(
            ...
            data=json.dumps({"jsonrpc": "2.0", "id": 1, "method": "resources/read", "params": {}}),
            content_type="application/json",
        )
...
class TestMcpProtocolPromptsList:
    ...
    def test_prompts_list_empty(self, client, db):
        ...
        response = client.post(
            ...
            data=json.dumps({"jsonrpc": "2.0", "id": 1, "method": "prompts/list", "params": {}}),
            content_type="application/json",
        )
...
class TestMcpProtocolPromptsGet:
            ...
            data=json.dumps(
                {
                    ...
                    "id": 1,
                    "method": "prompts/get",
                    "params": {"name": "test_prompt", "arguments": {"name": "Alice", "age": "30"}},
                }
            ),
            content_type="application/json",
        )
    ...
    def test_prompts_get_missing_name(self, client, db):
        ...
        response = client.post(
            ...
            data=json.dumps({"jsonrpc": "2.0", "id": 1, "method": "prompts/get", "params": {"arguments": {}}}),
            content_type="application/json",
        )
