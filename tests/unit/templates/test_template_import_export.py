...
from app.models.models import McpCapabilityTemplate, McpServiceTemplate
...
"""
        ...
        response = auth_client.post("/api/mcp-templates/import", data=yaml_data, content_type="application/x-yaml")
...
"""
        ...
        response = auth_client.post("/api/mcp-templates/import", data=invalid_yaml, content_type="application/x-yaml")
    ...
    def test_export_import_roundtrip(self, auth_client, db):
        ...
        import_response = auth_client.post(
            "/api/mcp-templates/import", data=exported_yaml, content_type="application/x-yaml"
        )
