...
class TestVariableModel:
    ...
    def test_create_variable(self, db):
        ...
        variable = Variable(
            name="TEST_VAR", value="test_value", source_type="manual", value_type="string", is_secret=False
        )
    ...
    def test_number_variable(self, db):
        ...
        variable = Variable(name="MAX_RETRIES", value="5", source_type="manual", value_type="number", is_secret=False)
        db.session.add(variable)
        db.session.commit()
...
class TestVariableAPI:
    ...
    def test_create_variable(self, auth_client):
        ...
        response = auth_client.post("/api/variables", data=json.dumps(payload), content_type="application/json")
    ...
    def test_get_variable_detail(self, auth_client, db):
        ...
        variable = Variable(name="DETAIL_VAR", source_type="manual", value_type="string", is_secret=False)
    ...
    def test_update_variable(self, auth_client, db):
        ...
        variable = Variable(
            name="UPDATE_VAR", value="old_value", source_type="manual", value_type="string", is_secret=False
        )
        db.session.add(variable)
        db.session.commit()

        payload = {"value": "new_value", "description": "Updated description"}
        response = auth_client.put(
            f"/api/variables/{variable.id}", data=json.dumps(payload), content_type="application/json"
        )
    ...
    def test_delete_variable(self, auth_client, db):
        ...
        variable = Variable(
            name="DELETE_VAR", value="delete_value", source_type="manual", value_type="string", is_secret=False
        )
        db.session.add(variable)
        db.session.commit()
    ...
    def test_duplicate_variable_name(self, auth_client, db):
        ...
        variable = Variable(name="DUPLICATE", source_type="manual", value_type="string", is_secret=False)
...
class TestVariableReplacement:
    ...
    def test_replace_in_url(self, db):
        ...
        # Create variable
        variable = Variable(name="API_ENDPOINT", source_type="manual", value_type="string", is_secret=False)
    ...
    def test_replace_in_headers(self, db):
        ...
        variable = Variable(name="AUTH_TOKEN", source_type="manual", value_type="string", is_secret=True)
...
class TestVariableViews:
    ...
    def test_variable_edit_view(self, auth_client, db):
        ...
        variable = Variable(
            name="EDIT_VIEW_VAR", value="value", source_type="manual", value_type="string", is_secret=False
        )
        db.session.add(variable)
        db.session.commit()
